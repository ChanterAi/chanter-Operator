// ── CHANTER Operator P1A: Runtime Bridge — Provider Routing Mirror ──
//
// Structural mirror of chanter-agent-runtime's `src/providerRouting.ts` (see
...
import type { RuntimeProduct } from "./contract.js";
